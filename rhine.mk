...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/recovery/c6x02.sh:install/bin/c6x02.sh \
    $(LOCAL_PATH)/recovery/c6806.sh:install/bin/c6806.sh
...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/rootdir/ueventd.qcom.rc:$(TARGET_COPY_OUT_VENDOR)/etc/ueventd.rc
...
# Vibrator
PRODUCT_PACKAGES += \
    android.hardware.vibrator@1.0-service.rhine
